...
lfreq=0;
ufreq=2000;
lfreq_mel=700*(10^(lfreq/3988));
ufreq_mel=700*(10^(ufreq/3988));
freqs_mel=linspace(lfreq_mel,ufreq_mel,no_filters+2);
freqs=3988*(log(freqs_mel/700)+1);

lfreq=2000;
ufreq=4000;
lfreq_mel=2595*log(1+lfreq/1000);
ufreq_mel=2595*log(1+ufreq/1000);
freqs_mel=linspace(lfreq_mel,ufreq_mel,no_filters+2);
freqs1=1000*(exp(freqs_mel/2595)-1);
freqs=[freqs freqs1];
